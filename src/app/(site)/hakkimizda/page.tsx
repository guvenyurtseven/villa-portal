  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 space-y-6">
      ...
      <p className="text-gray-700 leading-7">
        Villa Portal, tatil villalarını güvenli ve hızlı şekilde keşfetmeniz için geliştirilen bir
      ...
      <div className="rounded-lg border bg-white p-4">
        ...
        <p className="text-sm text-gray-700">E-posta: info@villaportal.com</p>
        <p className="text-sm text-gray-700">Telefon: +90 000 000 00 00</p>
      </div>
